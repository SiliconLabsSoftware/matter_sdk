...
<<<<<<< HEAD:src/app/codegen-data-model-provider/tests/TestCodegenModelViaMocks.cpp
...
>>>>>>> csa/v1.4.2-branch:src/data-model-providers/codegen/tests/TestCodegenModelViaMocks.cpp
{
