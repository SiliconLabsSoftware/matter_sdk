...
#if (CHIP_SYSTEM_CONFIG_USE_SOCKETS || CHIP_SYSTEM_CONFIG_USE_NETWORK_FRAMEWORK) && !defined(CHIP_SYSTEM_CONFIG_USE_SOCKETS_PLATFORM)
...
#if (CHIP_SYSTEM_CONFIG_USE_SOCKETS || CHIP_SYSTEM_CONFIG_USE_NETWORK_FRAMEWORK) && !defined(__ZEPHYR__) && !defined(__MBED__) && !defined(CHIP_SYSTEM_CONFIG_USE_SOCKETS_PLATFORM)
...
#if CHIP_SYSTEM_CONFIG_USE_SOCKETS && (defined(__ZEPHYR__) || defined(CHIP_SYSTEM_CONFIG_USE_SOCKETS_PLATFORM))
...
#if (CHIP_SYSTEM_CONFIG_USE_SOCKETS || CHIP_SYSTEM_CONFIG_USE_NETWORK_FRAMEWORK) && !defined(__ZEPHYR__) && !CHIP_SYSTEM_CONFIG_USE_SOCKETS_PLATFORM
...
#if CHIP_SYSTEM_CONFIG_USE_SOCKETS && !CHIP_SYSTEM_CONFIG_USE_ZEPHYR_SOCKETS && !CHIP_SYSTEM_CONFIG_USE_SOCKETS_PLATFORM
