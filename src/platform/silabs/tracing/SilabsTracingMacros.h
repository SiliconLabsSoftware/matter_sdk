...
#define SILABS_TRACE_BEGIN(operation) TEMPORARY_RETURN_IGNORED ::chip::Tracing::Silabs::SilabsTracer::Instance().TimeTraceBegin(operation)
#define SILABS_TRACE_END(operation) TEMPORARY_RETURN_IGNORED ::chip::Tracing::Silabs::SilabsTracer::Instance().TimeTraceEnd(operation)
#define SILABS_TRACE_END_ERROR(operation, error) TEMPORARY_RETURN_IGNORED ::chip::Tracing::Silabs::SilabsTracer::Instance().TimeTraceEnd(operation, error)
#define SILABS_TRACE_INSTANT(operation) TEMPORARY_RETURN_IGNORED ::chip::Tracing::Silabs::SilabsTracer::Instance().TimeTraceInstant(operation)
