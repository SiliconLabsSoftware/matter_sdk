...
CHIP_ERROR BleChannelMatterSiWx::SendWriteRequest(BleConnectionHandle conId, uint16_t charHandle, const uint8_t * data,
                                                  size_t length)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}

CHIP_ERROR BleChannelMatterSiWx::SubscribeCharacteristic(BleConnectionHandle conId, uint16_t charHandle)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}

CHIP_ERROR BleChannelMatterSiWx::UnsubscribeCharacteristic(BleConnectionHandle conId, uint16_t charHandle)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}
...
CHIP_ERROR BleChannelMatterSiWx::GetDeviceName(char * buf, size_t bufSize)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}
