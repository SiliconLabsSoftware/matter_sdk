...
CHIP_ERROR BleChannelMatterEfr32::SendWriteRequest(BleConnectionHandle conId, uint16_t charHandle, const uint8_t * data,
                                                   size_t length)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}

CHIP_ERROR BleChannelMatterEfr32::SubscribeCharacteristic(BleConnectionHandle conId, uint16_t charHandle)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}

CHIP_ERROR BleChannelMatterEfr32::UnsubscribeCharacteristic(BleConnectionHandle conId, uint16_t charHandle)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}
...
CHIP_ERROR BleChannelMatterEfr32::GetDeviceName(char * buf, size_t bufSize)
{
    return CHIP_ERROR_UNSUPPORTED_CHIP_FEATURE;
}
