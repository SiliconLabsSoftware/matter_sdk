...
#define SL_SI91X_EXT_FEAT_XTAL_CLK_ENABLE SL_SI91X_EXT_FEAT_XTAL_CLK_ENABLE(2)
#else
#define SL_SI91X_EXT_FEAT_XTAL_CLK_ENABLE SL_SI91X_EXT_FEAT_XTAL_CLK_ENABLE(1)
#endif

#ifdef SLI_SI917
#if WIFI_ENABLE_SECURITY_WPA3_TRANSITION // Adding Support for WPA3 transition
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP                                                                                             \
    (SL_SI91X_EXT_FEAT_LOW_POWER_MODE | SL_SI91X_EXT_FEAT_XTAL_CLK_ENABLE | SL_SI91X_RAM_LEVEL_NWP_BASIC_MCU_ADV |              \
