...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP                                                                                             \
    (SL_SI91X_EXT_FEAT_LOW_POWER_MODE | SL_SI91X_CLK | MEMORY_CONFIG | FRONT_END_SWITCH_CTRL | SL_SI91X_EXT_FEAT_IEEE_80211W)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (SL_SI91X_EXT_FEAT_LOW_POWER_MODE | SL_SI91X_CLK | MEMORY_CONFIG | FRONT_END_SWITCH_CTRL)
