...
{
    return SL_TOKEN_TYPE_STATIC_SECURE | kMatterStaticKeyDomain | id;
}
#else
...
#ifdef SL_TOKEN_MANAGER_DEFINES_H
    static constexpr Key kConfigKey_Creds_Dac = SilabsSecureTokenKey(0x00);
    static constexpr Key kConfigKey_Creds_Pai = SilabsSecureTokenKey(0x32);
    static constexpr Key kConfigKey_Creds_CD  = SilabsSecureTokenKey(0x33);
#endif
    // Matter Config Keys
