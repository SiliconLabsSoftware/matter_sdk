...
class GeneralCommissioningCluster(
  ...
  class SetTCAcknowledgementsResponse(val errorCode: UByte)
  ...
  sealed class BasicCommissioningInfoAttributeSubscriptionState {
    data class Success(val value: GeneralCommissioningClusterBasicCommissioningInfo) :
...
>>>>>>> csa/v1.4.2-branch
  ...
  suspend fun setTCAcknowledgements(
    ...
    return SetTCAcknowledgementsResponse(errorCode_decoded)
  }
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Breadcrumb attribute not found in Node State update" }
  ...
  suspend fun subscribeBasicCommissioningInfoAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        is SubscriptionState.SubscriptionErrorNotification -> {
          emit(
            BasicCommissioningInfoAttributeSubscriptionState.Error(
              Exception(
                "Subscription terminated with error code: ${subscriptionState.terminationCause}"
              )
            )
  ...
  suspend fun readTCAcceptedVersionAttribute(): UShort? {
    ...
    requireNotNull(attributeData) { "Tcacceptedversion attribute not found in response" }
  ...
  suspend fun readTCMinRequiredVersionAttribute(): UShort? {
    ...
    requireNotNull(attributeData) { "Tcminrequiredversion attribute not found in response" }
  ...
  suspend fun readTCAcknowledgementsAttribute(): UShort? {
    ...
    requireNotNull(attributeData) { "Tcacknowledgements attribute not found in response" }
  ...
  suspend fun readTCAcknowledgementsRequiredAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Tcacknowledgementsrequired attribute not found in response" }
  ...
  suspend fun readTCUpdateDeadlineAttribute(): TCUpdateDeadlineAttribute {
    ...
    requireNotNull(attributeData) { "Tcupdatedeadline attribute not found in response" }
