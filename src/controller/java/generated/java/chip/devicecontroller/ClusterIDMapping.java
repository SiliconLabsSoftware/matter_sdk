...
public class ClusterIDMapping {
    ...
    public static class Multicast implements BaseCluster {
        ...
        public enum Command {
            ...
            public static Command value(long id) throws NoSuchFieldError {
                ...
                throw new NoSuchFieldError();
        ...
        }public enum SetTargetCommandField {GroupId(0),Endpoints(1),Key(2),GracePeriod(3),;
                    private final int id;
                ...
                }public enum RemoveTargetCommandField {GroupId(0),Endpoints(1),GracePeriod(2),;
                    private final int id;
                    RemoveTargetCommandField(int id) {
                        this.id = id;
                    }
                    ...
                    public static RemoveTargetCommandField value(int id) throws NoSuchFieldError {
                        for (RemoveTargetCommandField field : RemoveTargetCommandField.values()) {
                        if (field.getID() == id) {
                            return field;
                        }
                        }
