...
private:
     ...
     *
     * Apple iphone/ipad, when commissioning, adds two fabric to the device. One for Apple Home or Google Home and one for the Appley Keychain.
     * Apple Home or Google Home is the active fabric which is used to communication with the device. The associated fabric also has the active
