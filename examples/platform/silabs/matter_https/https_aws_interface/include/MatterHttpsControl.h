 ...
 *
 ******************************************************************************/
#ifndef __MATTER_HTTPS_CONTROL_H
#define __MATTER_HTTPS_CONTROL_H
...
namespace control {
void MatterHttpsIncomingDataCb(void * arg, const char * topic, const uint8_t * data, uint16_t len, uint8_t flags);
...
#endif //__MATTER_HTTPS_CONTROL_H
