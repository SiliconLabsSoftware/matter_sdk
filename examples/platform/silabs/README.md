...
A feature-rich Qt-based dual-terminal interface for monitoring and interacting with Silicon Labs devices over serial connections. Designed specifically for Matter development with advanced log filtering and session management capabilities.
...
- Changing filters instantly shows/hides relevant messages
...
- [Matter Project Documentation](../../docs/)
- [Silicon Labs Platform Documentation](../../docs/platforms/)
- [Serial Communication Guide](../../docs/guides/)
