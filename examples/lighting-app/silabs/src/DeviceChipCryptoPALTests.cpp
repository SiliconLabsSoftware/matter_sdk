...
// On-device port of src/crypto/tests/TestChipCryptoPAL.cpp

#include "DeviceChipCryptoPALTestMacros.h"
...
static CHIP_ERROR DeviceCryptoTest_TestAES_CTR_128CryptTestVectors()
{
...
static CHIP_ERROR DeviceCryptoTest_TestAES_CCM_128EncryptTestVectors()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestAES_CCM_128DecryptTestVectors()
{
    HeapChecker heapChecker;
    int numOfTestVectors = MATTER_ARRAY_SIZE(ccm_128_test_vectors);
    int numOfTestsRan    = 0;
...
static CHIP_ERROR DeviceCryptoTest_TestAES_CCM_128InPlaceEncryption()
{
    HeapChecker heapChecker;
    int numOfTestVectors = MATTER_ARRAY_SIZE(ccm_128_test_vectors);
    int numOfTestsRan    = 0;
    ...
    for (int vectorIndex = 0; vectorIndex < numOfTestVectors; vectorIndex++)
    {
        ...
        if (vector->result == CHIP_NO_ERROR)
        {
            ...
            if (!areCTsEqual)
            {
                ChipLogError(Crypto, "Test %u failed", vector->tcId);
                DEVICE_TEST_FAIL();
            }
            if (!areTagsEqual)
            {
...
// This pattern is more widely used in the Matter Stack
static CHIP_ERROR DeviceCryptoTest_TestAES_CCM_128InPlaceDecryption()
{
    HeapChecker heapChecker;
    int numOfTestVectors = MATTER_ARRAY_SIZE(ccm_128_test_vectors);
    int numOfTestsRan    = 0;
...
static CHIP_ERROR DeviceCryptoTest_TestAES_CCM_128EncryptInvalidNonceLen()
{
    HeapChecker heapChecker;
    int numOfTestVectors = MATTER_ARRAY_SIZE(ccm_128_test_vectors);
    int numOfTestsRan    = 0;
...
static CHIP_ERROR DeviceCryptoTest_TestAES_CCM_128EncryptInvalidTagLen()
{
    HeapChecker heapChecker;
    int numOfTestVectors = MATTER_ARRAY_SIZE(ccm_128_test_vectors);
    int numOfTestsRan    = 0;
...
static CHIP_ERROR DeviceCryptoTest_TestAES_CCM_128DecryptInvalidNonceLen()
{
    HeapChecker heapChecker;
    int numOfTestVectors = MATTER_ARRAY_SIZE(ccm_128_test_vectors);
    int numOfTestsRan    = 0;
...
static CHIP_ERROR DeviceCryptoTest_TestSymmetricKeyHandleOpaqueBytesRoundTrip()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestSensitiveDataBuffer()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestSensitiveDataFixedBuffer()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestAsn1Conversions()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestRawIntegerToDerValidCases()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestRawIntegerToDerInvalidCases()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestReadDerLengthValidCases()
{
...
static CHIP_ERROR DeviceCryptoTest_TestReadDerLengthInvalidCases()
{
...
static CHIP_ERROR DeviceCryptoTest_TestHash_SHA256()
{
    HeapChecker heapChecker;
    ...
    for (numOfTestsExecuted = 0; numOfTestsExecuted < numOfTestCases; numOfTestsExecuted++)
    {
        ...
        if (!success)
        {
            ChipLogError(Crypto, "Failed TestHash_SHA256 sub-case %d", numOfTestsExecuted);
        }
        EXPECT_TRUE(success);
    }
...
static CHIP_ERROR DeviceCryptoTest_TestHash_SHA256_Stream()
{
    HeapChecker heapChecker;
    unsigned int numOfTestCases     = MATTER_ARRAY_SIZE(hash_sha256_test_vectors);
    unsigned int numOfTestsExecuted = 0;
    ...
    for (numOfTestsExecuted = 0; numOfTestsExecuted < numOfTestCases; numOfTestsExecuted++)
    {
        ...
        if (!success)
        {
            ChipLogError(Crypto, "Failed TestHash_SHA256_Stream sub-case %d", numOfTestsExecuted);
        }
        EXPECT_TRUE(success);
    }
...
static CHIP_ERROR DeviceCryptoTest_TestHMAC_SHA256_RawKey()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestHMAC_SHA256_RawKey_PsaFailurePropagates()
{
...
#if !(CHIP_CRYPTO_KEYSTORE_APP)
static CHIP_ERROR DeviceCryptoTest_TestHMAC_SHA256_KeyHandle()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestHKDF_SHA256()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestDRBG_InvalidInputs()
{
    HeapChecker heapChecker;
    CHIP_ERROR error = CHIP_NO_ERROR;
...
static CHIP_ERROR DeviceCryptoTest_TestDRBG_Output()
{
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_Signing_SHA256_Msg()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_Signing_SHA256_Hash()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_ValidationFailsDifferentMessage()
{
    HeapChecker heapChecker;
    const char * msg  = "Hello World!";
    size_t msg_length = strlen(msg);
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_ValidationFailIncorrectMsgSignature()
{
    HeapChecker heapChecker;
    const char * msg  = "Hello World!";
    size_t msg_length = strlen(msg);
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_ValidationFailIncorrectHashSignature()
{
    HeapChecker heapChecker;
    const uint8_t msg[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
                            0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F };
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_SigningMsgInvalidParams()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_ValidationMsgInvalidParam()
{
    HeapChecker heapChecker;
    const char * msg  = "Hello World!";
    size_t msg_length = strlen(msg);
...
static CHIP_ERROR DeviceCryptoTest_TestECDSA_ValidationHashInvalidParam()
{
    HeapChecker heapChecker;
    const uint8_t msg[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
                            0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F };
...
static CHIP_ERROR DeviceCryptoTest_TestP256_DeterministicECDSA_Sanity()
{
    HeapChecker heapChecker;
    P256Keypair keypair;
...
static CHIP_ERROR DeviceCryptoTest_TestP256_DeterministicECDSA_TestVectors()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestECDH_EstablishSecret()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestAddEntropySources()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestPBKDF2_SHA256_TestVectors()
{
    HeapChecker heapChecker;
    ...
    for (int vectorIndex = 0; vectorIndex < numOfTestVectors; vectorIndex++)
    {
        ...
        if (vector->plen > 0)
        {
            ...
            if (err != vector->result)
            {
                ChipLogError(Crypto, "Failed TestPBKDF2_SHA256_TestVectors sub-case %d", vectorIndex);
            }
            EXPECT_EQ(err, vector->result);

            if (vector->result == CHIP_NO_ERROR)
            {
                bool success = memcmp(out_key.Get(), vector->key, vector->key_len) == 0;
                if (!success)
                {
                    ChipLogError(Crypto, "Failed TestPBKDF2_SHA256_TestVectors sub-case %d", vectorIndex);
                }
...
// PSA_ERROR_NOT_SUPPORTED; the PAL must return a non-success CHIP_ERROR.
static CHIP_ERROR DeviceCryptoTest_TestPBKDF2_SHA256_PsaFailurePropagates()
{
...
static CHIP_ERROR DeviceCryptoTest_TestP256_Keygen()
{
    HeapChecker heapChecker;
    P256Keypair keypair;
    EXPECT_EQ(keypair.Initialize(ECPKeyTarget::ECDSA), CHIP_NO_ERROR);
...
static CHIP_ERROR DeviceCryptoTest_TestP256_InitializeFromBitsOrReject()
{
    HeapChecker heapChecker;
    P256Keypair keypair;
...
static CHIP_ERROR DeviceCryptoTest_TestCSR_Verify()
{
...
static CHIP_ERROR DeviceCryptoTest_TestCSR_GenDirect()
{
...
static CHIP_ERROR DeviceCryptoTest_TestCSR_GenByKeypair()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestKeypair_Serialize()
{
    HeapChecker heapChecker;
    Test_P256Keypair keypair;
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_spake2p_FEMul()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_spake2p_FELoadWrite()
{
    HeapChecker heapChecker;
    uint8_t fe_out[kMAX_FE_Length];
    ...
    for (int vectorIndex = 0; vectorIndex < numOfTestVectors; vectorIndex++)
    {
        ...
        bool success = memcmp(fe_out, vector->fe_out, vector->fe_out_len) == 0;
        if (!success)
        {
            ChipLogError(Crypto, "Failed TestSPAKE2P_spake2p_FELoadWrite sub-case %d", vectorIndex);
        }
        EXPECT_TRUE(success);
        numOfTestsRan += 1;
    }
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_spake2p_Mac()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_spake2p_PointMul()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_spake2p_PointMulAdd()
{
    HeapChecker heapChecker;
    uint8_t output[kMAX_Point_Length];
    size_t out_len = sizeof(output);
    ...
    for (int vectorIndex = 0; vectorIndex < numOfTestVectors; vectorIndex++)
    {
        ...
        bool success = memcmp(output, vector->out_point, vector->out_point_len) == 0;
        if (!success)
        {
            ChipLogError(Crypto, "Failed TestSPAKE2P_spake2p_PointMulAdd sub-case %d", vectorIndex);
        }
        EXPECT_TRUE(success);
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_spake2p_PointLoadWrite()
{
    HeapChecker heapChecker;
    uint8_t output[kMAX_Point_Length];
    size_t out_len = sizeof(output);
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_spake2p_PointIsValid()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_RFC()
{
    HeapChecker heapChecker;
    CHIP_ERROR error = CHIP_NO_ERROR;
...
static CHIP_ERROR DeviceCryptoTest_TestSPAKE2P_Reuse()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestCompressedFabricIdentifier()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestPubkey_x509Extraction()
{
...
static CHIP_ERROR DeviceCryptoTest_TestX509_VerifyAttestationCertificateFormat()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestX509_CertChainValidation()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestX509_IssuingTimestampValidation()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestSKID_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestAKID_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestCDPExtension_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestCDPCRLIssuerExtension_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestSerialNumber_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestSubject_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestIssuer_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestVIDPID_StringExtraction()
{
    HeapChecker heapChecker;
...
static CHIP_ERROR DeviceCryptoTest_TestVIDPID_x509Extraction()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestX509_ReplaceCertIfResignedCertFound()
{
    using namespace TestCerts;
...
static CHIP_ERROR DeviceCryptoTest_TestGroup_OperationalKeyDerivation()
{
...
static CHIP_ERROR DeviceCryptoTest_TestGroup_SessionIdDerivation()
{
...
static CHIP_ERROR DeviceCryptoTest_TestGroup_PrivacyKeyDerivation()
{
    uint8_t key_buffer[Crypto::CHIP_CRYPTO_SYMMETRIC_KEY_LENGTH_BYTES] = { 0 };
...
static CHIP_ERROR DeviceCryptoTest_GenerateVendorFabricBindingMessageWorks()
{
...
// Test vectors for this come from Matter Spec test vectors (Matter spec Appendix F.5).
static CHIP_ERROR DeviceCryptoTest_GenerateVendorIdVerificationToBeSignedWorks()
{
...
static CHIP_ERROR DeviceCryptoTest_PemEncodingWorks()
{
...
static CHIP_ERROR DeviceCryptoTest_KeyIdStringifierWorks()
{
...
static CHIP_ERROR DeviceCryptoTest_TestHazardousOperationLoadKeypairFromRaw()
{
    HeapChecker heapChecker;
...
struct DeviceCryptoTestEntry
{
    const char * name;
    CHIP_ERROR (*fn)();
};

#define DEVICE_CRYPTO_TEST_ENTRY(fn)                                                                                               \
    {                                                                                                                              \
        #fn, fn                                                                                                                    \
    }

static const DeviceCryptoTestEntry kDeviceCryptoTests[] = {
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CTR_128CryptTestVectors),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CCM_128EncryptTestVectors),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CCM_128DecryptTestVectors),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CCM_128InPlaceEncryption),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CCM_128InPlaceDecryption),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CCM_128EncryptInvalidNonceLen),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CCM_128EncryptInvalidTagLen),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAES_CCM_128DecryptInvalidNonceLen),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSymmetricKeyHandleOpaqueBytesRoundTrip),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSensitiveDataBuffer),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSensitiveDataFixedBuffer),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAsn1Conversions),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestRawIntegerToDerValidCases),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestRawIntegerToDerInvalidCases),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestReadDerLengthValidCases),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestReadDerLengthInvalidCases),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHash_SHA256),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHash_SHA256_Stream),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHMAC_SHA256_RawKey),
#if CHIP_CRYPTO_PSA
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHMAC_SHA256_RawKey_PsaFailurePropagates),
#endif
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHMAC_SHA256_KeyHandle),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHKDF_SHA256),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestDRBG_InvalidInputs),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestDRBG_Output),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_Signing_SHA256_Msg),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_Signing_SHA256_Hash),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_ValidationFailsDifferentMessage),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_ValidationFailIncorrectMsgSignature),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_ValidationFailIncorrectHashSignature),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_SigningMsgInvalidParams),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_ValidationMsgInvalidParam),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDSA_ValidationHashInvalidParam),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestP256_DeterministicECDSA_Sanity),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestP256_DeterministicECDSA_TestVectors),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestECDH_EstablishSecret),
#if CHIP_CRYPTO_MBEDTLS || CHIP_CRYPTO_OPENSSL
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAddEntropySources),
#endif
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestPBKDF2_SHA256_TestVectors),
#if CHIP_CRYPTO_PSA
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestPBKDF2_SHA256_PsaFailurePropagates),
#endif
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestP256_Keygen),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestP256_InitializeFromBitsOrReject),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestCSR_Verify),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestCSR_GenDirect),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestCSR_GenByKeypair),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestKeypair_Serialize),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_spake2p_FEMul),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_spake2p_FELoadWrite),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_spake2p_Mac),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_spake2p_PointMul),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_spake2p_PointMulAdd),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_spake2p_PointLoadWrite),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_spake2p_PointIsValid),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_RFC),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSPAKE2P_Reuse),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestCompressedFabricIdentifier),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestPubkey_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestX509_VerifyAttestationCertificateFormat),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestX509_CertChainValidation),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestX509_IssuingTimestampValidation),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSKID_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestAKID_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestCDPExtension_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestCDPCRLIssuerExtension_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSerialNumber_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestSubject_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestIssuer_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestVIDPID_StringExtraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestVIDPID_x509Extraction),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestX509_ReplaceCertIfResignedCertFound),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestGroup_OperationalKeyDerivation),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestGroup_SessionIdDerivation),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestGroup_PrivacyKeyDerivation),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_GenerateVendorFabricBindingMessageWorks),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_GenerateVendorIdVerificationToBeSignedWorks),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_PemEncodingWorks),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_KeyIdStringifierWorks),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHazardousOperationLoadKeypairFromRaw),
};

// Crypto exercised by protocols/secure_channel/PASESession (PBKDF2 verifier, SPAKE2P rounds, session keys).
static const DeviceCryptoTestEntry kPASECryptoTests[] = {
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHash_SHA256),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestHash_SHA256_Stream),
    DEVICE_CRYPTO_TEST_ENTRY(DeviceCryptoTest_TestPBKDF2_SHA256_TestVectors),
#if CHIP_CRYPTO_PSA
...
CHIP_ERROR RunDeviceCryptoTestSuite(const char * suiteName, const DeviceCryptoTestEntry * tests, size_t testCount)
{
#if CHIP_CRYPTO_PSA
    psa_crypto_init();
    ...
    ChipLogProgress(Crypto, "Running %u %s", static_cast<unsigned>(testCount), suiteName);

    for (size_t i = 0; i < testCount; ++i)
    {
        const auto & test                            = tests[i];
        DeviceChipCryptoPALTestDetail::FailureFlag() = false;
        CHIP_ERROR err                               = test.fn();
        if (err == CHIP_NO_ERROR)
        {
            passed++;
            ChipLogDetail(Crypto, "PASS: %s", test.name);
        }
        else
        {
            failed++;
            ChipLogError(Crypto, "FAIL: %s: %" CHIP_ERROR_FORMAT, test.name, err.Format());
        }
    }

    ChipLogProgress(Crypto, "%s: %d passed, %d failed", suiteName, passed, failed);
    return failed > 0 ? CHIP_ERROR_INTERNAL : CHIP_NO_ERROR;
}

} // namespace

CHIP_ERROR RunAllDeviceChipCryptoPALTests()
{
    return RunDeviceCryptoTestSuite("DeviceChipCryptoPAL tests", kDeviceCryptoTests, MATTER_ARRAY_SIZE(kDeviceCryptoTests));
}

CHIP_ERROR RunPASEChipCryptoPALTests()
{
    return RunDeviceCryptoTestSuite("PASE crypto PAL tests", kPASECryptoTests, MATTER_ARRAY_SIZE(kPASECryptoTests));
}
