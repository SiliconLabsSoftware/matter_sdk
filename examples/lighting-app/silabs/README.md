...
-   **Methods that already exist in the AppTask** — Customize them
    by overriding the matching `*Impl()` method in `CommonAppTask`. Do not edit
    the `AppTask.cpp` for app-specific behavior.
